...
public class COTSFalconSwerveConstants {
    ...
    public static COTSFalconSwerveConstants SDSMK3(double driveGearRatio){
        ...
        /** 12.8 : 1 */
        double angleGearRatio = (32.0 / 3.0);
    ...
    public static COTSFalconSwerveConstants SDSMK4(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(32.0 / 3.0);
    ...
    public static COTSFalconSwerveConstants SDSMK4i(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4.0); //May need to change as wheels wear down or are switched.

        double angleGearRatio = ((150.0 / 7.0) / 1.0); //For MK4I mods, keep this the same always.

        double angleKP = 0.09; //Might need to change; modules were jittery when first calibrating them
        double angleKI = 0.0;
        double angleKD = 0.0;
        double angleKF = 0.0;
